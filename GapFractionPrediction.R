...
#Data2 = Data[, c("PlotID", "luse", "no.of.gaps",	"gap.area") := NULL]
...
model.type <- "RF" # specify the type of model = Random Forest

folder <- getwd() # select the directory to store the model output
...
rastLUTfn <- "BokEfoul_Gamma0GF_LUT_B1.csv" # select the csv file with link/names of all SAR images
